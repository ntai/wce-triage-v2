...
def install_vs_code():
  ...
  cat = subprocess.Popen('sudo -H cat > /etc/apt/sources.list.d/vscode.list', shell=True, stdin=subprocess.PIPE)
  cat.communicate("deb [arch=amd64 signed-by=/usr/share/keyrings/packages.microsoft.gpg] https://packages.microsoft.com/repos/vscode stable main".encode('utf-8'))
